...
public class DgClusterInfo {
	...
	@NotEmpty(message="Cluster Name:"+BeanValidator.EMPTY_FIELD)
	@Size(max=128, message="Cluster Name:"+BeanValidator.MAX_SIZE_128)
	@Pattern (regexp=BeanValidator.GENERIC_TEXT_REGEX, message="Cluster Name:"+BeanValidator.INVALID_CHARACTER_SET)
