...
/**
 * <p>
 * Java class for ftpTaskTemplatePatterns complex type.
 * 
 * <p>
 ...
 * 
 * <pre>
 * &lt;complexType name="ftpTaskTemplatePatterns">
 *   &lt;complexContent>
...
@XmlType(name = "ftpTaskTemplatePatterns", propOrder = { "checkCode",
		"columnId", "columnName", "consistent", "constraintName", "dataLength",
		"dataPrecision", "dataScale", "dataType", "dataTypeNumber",
		"databaseName", "dbLink", "id", "ifNullValue", "ifValueNotFound",
		"isIdentity", "isNullable", "keepNull", "maskFlag", "maskSeq",
		"maskingOption", "maskingPolicy", "missingValuesAs", "param1",
		"param2", "param3", "param4", "param5", "param6", "param7", "param8",
		"param9", "persistent", "persistentColumnId", "regexId", "schemaName",
		"synchronizeWith", "tableMaskSeq", "tableName", "templateId",
		"fConstraintType", "fUnique" })
public class FtpTaskTemplatePatterns {
