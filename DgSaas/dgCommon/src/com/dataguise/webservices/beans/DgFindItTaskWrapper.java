...
@XmlType(name = "dgFindItTaskWrapper", propOrder = { "dgFindItTaskList",
		"totalRecords" })
public class DgFindItTaskWrapper {

	@XmlElement(nillable = true)
	protected List<DgDatabaseFindTask> dgFindItTaskList;
	 ...
	 * 
	 */
	public List<DgDatabaseFindTask> getDgFindItTaskList() {
		if (dgFindItTaskList == null) {
			dgFindItTaskList = new ArrayList<DgDatabaseFindTask>();
		}
		return this.dgFindItTaskList;
	}
